@extends('layouts.app')
<title>Download Resume Material</title>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="guideline-box">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="guideline-step"><span style="font-weight: bolder">2.</span> Save the <b>.xlsb</b> file</li>
        ...
        <div class="col-md-9">
            <div class="form-container">
                <h3>Download Resume Material Application</h3>
                
                <p>Click the button below to download the Resume Material List All Block application:</p>
                
                <a href="{{ route('resume.download') }}" 
                   class="btn btn-primary" 
                   id="download-btn">
                    <i class="fas fa-download"></i> Download Aplikasi Resume Material List All Block.xlsb
                </a>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        downloadBtn.addEventListener('click', async (e) => {
            ...
            try {
                ...
                downloadBtn.innerHTML = '<i class="fas fa-download"></i> Download Aplikasi Resume Material List All Block.xlsb';
            }
        });
    });
</script>
