    ...
    <section class="bg-gray-100 mb-20">
        <div class="container items-center">
            <div class=" items-center text-center">
                <h2 style="text-align: center;">Create QR Codes, Barcodes and Short Links
                </h2>
            </div>
        </div>
                ...
                <table class="table table-bordered mx-auto" style="width: 50%;">
                    <thead>
                        <tr class="text-center">
                            <th class="clickable-th" data-form-url="{{ route('showForm', ['form' => 'QRcode']) }}">
                                <a href="#" class="form-link"
                                    data-form-url="{{ route('showForm', ['form' => 'QRcode']) }}"><svg class="icons"
                                        xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 26"
                                        fill="none">
                            ...
                            <th class="clickable-th" data-form-url="{{ route('showForm', ['form' => 'shortened_url']) }}">
                                <a href="#" class="form-link"
                                    data-form-url="{{ route('showForm', ['form' => 'shortened_url']) }}"><svg class="icons"
                                        xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 26"
                                        fill="none">
                                        <path
