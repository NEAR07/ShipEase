...
use App\Http\Controllers\pdfWordController;
...
//Pdf-to-Docx
Route::get('/pdf-to-word', [pdfWordController::class, 'showUploadForm'])->name('upload.form');
Route::post('/convert', [pdfWordController::class, 'convertPdfToDocx'])->name('convert');
